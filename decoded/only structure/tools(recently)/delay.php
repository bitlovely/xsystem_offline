    ...
    if($argc > 2) {
        ...
        if($f566700a43ee8e1f0412fe10fbdf03df->d1E5cE3B87bb868B9e6EFd39aa355A4F() > 0) {
            ...
            if(!($Cb08b127bfe426d7f3ccbd3e38f05471["delay_minutes"] == 0 || $Cb08b127bfe426d7f3ccbd3e38f05471["parent_id"] != 0)) {
                ...
                $E32190558705873b39f90bdb17221fd6 = [];
                $E32190558705873b39f90bdb17221fd6 = ["vars" => ["#EXTM3U" => "", "#EXT-X-VERSION" => 3, "#EXT-X-MEDIA-SEQUENCE" => "0", "#EXT-X-ALLOW-CACHE" => "YES", "#EXT-X-TARGETDURATION" => A78bF8D35765bE2408c50712Ce7A43Ad::$SegmentsSettings["seg_time"]], "segments" => []];
                ...
                $ec0af356ee19bf81bc8dd6124c92ce80 = [];
...
{
    $C325d28e238c3a646bd7b095aa1ffa85 = [];
    if(empty($ec0af356ee19bf81bc8dd6124c92ce80)) {
    } else {
        ...
        for ($C48e0083a9caa391609a3c645a2ec889 = 0; !($C48e0083a9caa391609a3c645a2ec889 < $fae9f9e542430541805d1ff49c901c6e && $C48e0083a9caa391609a3c645a2ec889 < count($ec0af356ee19bf81bc8dd6124c92ce80)); $C48e0083a9caa391609a3c645a2ec889++) {
            ...
            if(count($C325d28e238c3a646bd7b095aa1ffa85) != $A029b77634bf5f67a52c7d5b31aed706) {
                ...
                if(!stristr($bb85be39ea05b75c9bffeff236bd9355, "EXTINF")) {
                    ...
                    if(!file_exists(DELAY_STREAM . $c5f97e03cbf94a57a805526a8288042f)) {
                        ...
                        $C325d28e238c3a646bd7b095aa1ffa85[] = ["seconds" => $Ba3faa92a82fb2d1bb6bb866cb272fee, "file" => $c5f97e03cbf94a57a805526a8288042f];
                    }
                }
                break;
            }
