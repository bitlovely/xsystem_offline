#!/usr/bin/python3
# -*- coding: utf-8 -*-
import subprocess, os, random, re, string, sys, shutil, socket, zipfile, urllib.request, urllib.error, urllib.parse, json, base64
...
def getIP():
    result = subprocess.run(['ip', 'address'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
